...
class AudioListener:
    ...
    def listen_continuously(self):
        ...
        listen_thread.start()
        logger.info("▶️ Started listening for director's voice commands...")
    ...
    def _listen_worker(self):
        ...
        with sr.Microphone() as source:
            ...
            logger.info("✅ Ready for your voice commands.")
            ...
            while True:
                try:
                    ...
                    logger.info(f"🎤 Director Said: '{text}'")
                    ...
                    logger.error(f"An unknown error occurred in audio listener: {e}", exc_info=True)
                    time.sleep(5)